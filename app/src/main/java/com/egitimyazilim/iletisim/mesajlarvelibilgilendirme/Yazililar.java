        ...
        buttonSMS.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!Izinler.checkPermission(getApplicationContext(), izinler)) {
                    Izinler.showRequestPermissionDialog(Yazililar.this,izinler,requestCodePermission);
                } else if (!spinnerSinif.getSelectedItem().toString().equals("Kayıtlı sınıf yok!")) {
                    if (!spinnerDers.getSelectedItem().toString().equals("Kayıtlı ders yok!")) {
                        durum1 = false;
